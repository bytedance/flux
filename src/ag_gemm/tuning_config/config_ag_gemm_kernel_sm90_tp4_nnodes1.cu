//===- config_ag_gemm_kernel_sm90_tp4_nnodes1.cu ----------------- C++ ---===//
//
...
static int config_ag_gemm_kernel_sm90_tp4_nnodes1 = []() {
  ...
  // EP Serving
  inst.add(make_gemm_meta(make_gemm_dtype_config(_S8{}(), _S8{}(), _Void{}(), _BF16{}(), _S32{}()),_Sm90{}(),_AGKernel{}(),_RCR{}(),_GemmV3{}()),make_runtime_config(4096,1792,5120,make_all_gather_runtime_config(4,1,0)),make_gemm_hparams(make_gemm_v3_hparams(cute::make_tuple(1l,2l,1l),_Cooperative{}()),None{},cute::make_tuple(128l,128l,128l),_GemmDefault{}(),3,_RasterAlongN{}()));
  inst.add(make_gemm_meta(make_gemm_dtype_config(_S8{}(), _S8{}(), _BF16{}(), _BF16{}(), _S32{}()),_Sm90{}(),_AGKernel{}(),_RCR{}(),_GemmV3{}()),make_runtime_config(4096,1792,5120,make_all_gather_runtime_config(4,1,0)),make_gemm_hparams(make_gemm_v3_hparams(cute::make_tuple(1l,2l,1l),_Cooperative{}()),None{},cute::make_tuple(128l,128l,128l),_GemmDefault{}(),3,_RasterAlongN{}()));
  return 0;
}();
}
// clang-format on
