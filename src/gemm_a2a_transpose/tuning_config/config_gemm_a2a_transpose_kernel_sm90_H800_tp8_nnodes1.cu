...
static int config_gemm_a2a_transpose_kernel_sm90_h800_tp8_nnodes1 = []() {
  ...
  // H800xM10
  inst.add(make_gemm_meta(make_gemm_dtype_config(_BF16{}(),_BF16{}(),_Void{}(),_BF16{}(),_FP32{}()),_Sm90{}(),_H800{}(),_PreAttnQKVPackAllToAll{}(),_RCR{}(),_GemmV3{}(),make_gemm_v3_meta(false,false),None{}),make_runtime_config(8192,14336,6144,make_all_to_all_transpose_runtime_config(8,1,0)),make_gemm_hparams(make_gemm_v3_hparams(cute::make_tuple(2l,1l,1l),_Cooperative{}()),None{},cute::make_tuple(128l,256l,64l),_GemmDefault{}(),4,_RasterAlongN{}()));
  // H20
  inst.add(make_gemm_meta(make_gemm_dtype_config(_BF16{}(),_BF16{}(),_Void{}(),_BF16{}(),_FP32{}()),_Sm90{}(),_H800{}(),_PreAttnQKVPackAllToAll{}(),_RCR{}(),_GemmV3{}(),make_gemm_v3_meta(false,false),None{}),make_runtime_config(8192,7168,5120,make_all_to_all_transpose_runtime_config(8,1,0)),make_gemm_hparams(make_gemm_v3_hparams(cute::make_tuple(2l,1l,1l),_PingPong{}()),None{},cute::make_tuple(128l,128l,64l),_GemmDefault{}(),0,_RasterAlongN{}()));
  inst.add(make_gemm_meta(make_gemm_dtype_config(_BF16{}(),_BF16{}(),_BF16{}(),_BF16{}(),_FP32{}()),_Sm90{}(),_H800{}(),_PreAttnQKVPackAllToAll{}(),_RCR{}(),_GemmV3{}(),make_gemm_v3_meta(false,false),None{}),make_runtime_config(8192,7168,5120,make_all_to_all_transpose_runtime_config(8,1,0)),make_gemm_hparams(make_gemm_v3_hparams(cute::make_tuple(2l,1l,1l),_PingPong{}()),None{},cute::make_tuple(128l,128l,64l),_GemmDefault{}(),0,_RasterAlongN{}()));
