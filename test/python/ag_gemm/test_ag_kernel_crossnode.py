...
# usage: torchrun --node_rank=0 --nproc_per_node=8 --nnodes=1 --rdzv_id=none --master_addr=127.0.0.1 --master_port=23456 test/python/ag_gemm/test_ag_kernel_acrossnode.py 4096 49152 12288
import argparse
import os
import time
